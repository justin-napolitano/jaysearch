...
4. add `bin/local-task-router` for compact routing decisions across local planner, worker handoff, remote worker, and human escalation
...
5. add focused tests for adapter, router, and runtime-check behavior
