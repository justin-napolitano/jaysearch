...
If the merge event or finalizer identity cannot be derived
deterministically, reconciliation must fail with explicit blockers rather
than silently leaving an authoritative plan in an ambiguous state.
