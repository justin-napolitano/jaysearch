...
def check_citations(root: str = ".") -> tuple[int, dict[str, Any]]:
    ...
    if not registry_path.exists():
        return 1, {"tool": "citation_check", "ok": False, "errors": ["missing_claim_registry"]}
    if not graph_path.exists():
        return 1, {"tool": "citation_check", "ok": False, "errors": ["missing_bibliography_graph"]}
    if not schema_path.exists():
        return 1, {"tool": "citation_check", "ok": False, "errors": ["missing_claim_registry_schema"]}
