...
58. `20260507-researcher-repo-architecture-codex-01-execplan`
   - status: `decision_gated`
   - goal: Define the standalone researcher repo and platform integration surface
...
60. `20260507-research-improvement-projection-codex-01-execplan`
   - status: `decision_gated`
   - goal: Project structured researcher improvement proposals through the platform capability command
   - implementation branch: `impl-execplan/20260507-research-improvement-projection-codex-01`
   - gate: `authoritative ExecPlan required before execution`

61. `20260507-ranked-candidate-promotion-codex-01-execplan`
   - status: `decision_gated`
   - goal: Project ranked research candidates and promotable follow-ups through the platform capability command
...
63. `20260507-repo-followup-packet-projection-codex-01-execplan`
   - status: `decision_gated`
   - goal: Project repo-specific follow-up packets from prepared research follow-ups
   - implementation branch: `impl-execplan/20260507-repo-followup-packet-projection-codex-01`
   - gate: `authoritative ExecPlan required before execution`

64. `20260507-platform-seed-draft-rendering-codex-01-execplan`
   - status: `decision_gated`
   - goal: Materialize follow-up packets and render platform draft ExecPlan artifacts
   - implementation branch: `impl-execplan/20260507-platform-seed-draft-rendering-codex-01`
   - gate: `authoritative ExecPlan required before execution`

65. `20260507-external-handoff-and-loop-runner-codex-01-execplan`
   - status: `decision_gated`
   - goal: Render external researcher handoffs and run the supervised research improvement loop
...
67. `20260511-candidate-selection-contract-codex-01-execplan`
   - status: `decision_gated`
   - goal: Formalize candidate selection and conflict resolution rules
   - implementation branch: `impl-execplan/20260511-candidate-selection-contract-codex-01`
   - gate: `authoritative ExecPlan required before execution`

68. `20260511-persistent-research-run-history-codex-01-execplan`
   - status: `decision_gated`
...
- canonical_last_graph_action_id: `rwg-action-20260511-register-rwg-068`
